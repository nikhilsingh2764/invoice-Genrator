...
router.post('/customer', CustomerLimiter, authMiddleware, createCustomerValidator, validate, createCustomer);

router.get('/customer', authMiddleware, getAllCustomers);

router.get('/customer/:id', authMiddleware, getCustomerById);

router.patch('/customer/:id', CustomerLimiter, authMiddleware, updateCustomerValidator, validate, updateCustomer);

router.delete('/customer/:id', CustomerLimiter, authMiddleware, deleteCustomer);
